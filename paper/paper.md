...
![Fig 1: `AstroGlue` GUI with a data set imported, plots chosen and `AstroLink` featurespace set. \label{fig:1}](AstroGlue_example/1.png) 
<br />
<br />
![Fig 2-a:  `Glue` session launched with all chosen plots and certain chosen clusters highlighted. \label{fig:2}](AstroGlue_example/2.png)
<br />
<br />
![Fig 2-b: `Glue` session with corresponding clusters in position and velocity space marked by arrows. \label{fig:3}](AstroGlue_example/3.png)
