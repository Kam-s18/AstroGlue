...
![Fig 1: `AstroGlue` GUI with a data set imported, plots chosen and `AstroLink` featurespace set.\label{fig:example}](<img width="1079" alt="1" src="https://github.com/user-attachments/assets/a6964e91-3344-40cf-a4b9-a22e082e05fb">) 
<figure>
